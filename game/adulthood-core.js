...
export function startAdultSexWork(state){if(months(state)<216)return null;return startAdultJob(state,{id:"adult-sex-work",title:"Independent sex work",income:22000+Math.round(roll(state,"adult-sex-work-income")*9000)});}
